import { closeDB, connectDB, requestRegister} from '../helpers.js';
...
beforeEach(async() => {
	...
	responseInvalidUser = await requestRegister({
		email:'NotEmail',
		password: ''
	});
});
...
describe('Post / Register / with successful User',() =>{
...
describe('Post / Register / with invalid User',() =>{
